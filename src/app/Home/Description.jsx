...
const Description = () => {
  return (
    <section className="overflow-hidden">
      <div className="relative flex bg-[rgba(0,0,0,0.9)] justify-between overflow-hidden">
        <div className="py-14 pl-26">
          <h3 data-aos="fade-down" className="font-mont text-3xl font-bold text-white">IT BERRIES</h3>
          <p data-aos="fade-right" className="max-w-[1150px] font-sans text-base text-white pt-16 pb-6.5">
          ...
          <Link 
            href="#" 
            data-aos="zoom-in"
            className="font-mont text-base font-semibold text-white border-l-2 border-r-2 px-4 py-2 hover:text-black hover:bg-white transition-all duration-300 before:border-white"
          >
            Read more
          </Link>
        </div>
