...
const Footer = () => {
  ...
  return (
    <footer className="bg-black">
      <div
        data-aos="zoom-in-up"
        className=" py-8 sm:py-12 lg:py-15 flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8"
      >
        <div className="flex justify-center items-center flex-col pb-8 sm:pb-10 lg:pb-11">
          ...
          >
            ...
            <p className="font-mont text-white px-4 font-bold text-sm sm:text-base mt-2">
              BACK TO TOP
            </p>
          </button>
        </div>
        <div className="w-full flex justify-center">
          <ul className="grid grid-cols-4 gap-4 sm:gap-6 lg:gap-7 max-w-md">
            <li className="flex justify-center">
              <Link
                href={"#"}
                className="font-mont text-white font-bold flex justify-center"
              >
                <Image
                  src={face}
                  alt="face image"
