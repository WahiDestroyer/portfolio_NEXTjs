    ...
    <section className='bg-[url(/images/banner/cover.png)]'>
        <div className='container flex justify-between items-center pt-18'>
            <div className=''>
                ...
                <div>
                    <h2 className='font-ral font-bold text-4xl text-black pb-14'>Hi, I am</h2>
                    <h1 className='font-ral text-7xl text-black font-bold'>Tomasz Gajda</h1>
                    <p className='font-extrabold text-sai font-ral text-2xl pb-32'>Front-end Developer / UI Designer</p>
                </div>
                <div className='flex gap-6 items-center'>
                    <Link href="#" className='w-10 h-10'>
                    <Image src={at} alt="at" className='bg-ds p-2.5'/>
                    </Link><Link href="#" className='w-10 h-10'>
